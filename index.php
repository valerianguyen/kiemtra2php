...
$sql = "SELECT masp, tensp, dongia, anh FROM sanpham";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if (is_array($images)) {
                            foreach ($images as $image) {
                                echo "<img src='" . htmlspecialchars($image) . "' alt='Ảnh sản phẩm' class='img-thumbnail' style='width: 100px; height: auto; margin-right: 10px;'>";
                            }
                        }
                        echo "</td>";
